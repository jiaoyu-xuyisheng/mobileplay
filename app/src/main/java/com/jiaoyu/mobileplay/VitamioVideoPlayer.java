...
import com.jiaoyu.mobileplay.View.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        tv_buffer_netspeed = (TextView) findViewById(R.id.tv_netSpeed);
        ll_buffer = (LinearLayout) findViewById(R.id.video_buffer);
        tv_laoding_netspeed = (TextView) findViewById(R.id.loading_text);
...
//        screenHeight = getWindowManager().getDefaultDisplay().getHeight();
    ...
    private void setListener() {
        MyOnPreparedListener mmp=new MyOnPreparedListener();
        //准备好的监听
        videoview.setOnPreparedListener(mmp);
